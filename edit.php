...
if(isset($_POST['submit'])){
     ...
     if( empty($name) || empty($salary ) || empty($email) || empty($cell) || empty($dpt)){
        ...
        $msg = validate('All fields are required');
           ...
           connect() -> query("UPDATE teachers SET name ='$name' ,salary ='$salary',email ='$email',cell ='$cell',department ='$dpt',gender ='$gender' ,education ='$edu', photo='$update_photo', updated_at ='$updated_at_time ' WHERE id ='$edit_id ' ");
